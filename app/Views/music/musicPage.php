...
<head>
    ...
    <style>
        /* Restoring the Immersive Player Styles */
        :root {
            --primary: #bd00ff;   
            --secondary: #00f3ff;
            --bg-dark: #050508; 
...
<body>
    ...
    <div class="hud-layer">
        <div class="top-bar">
             <a href="<?= BASE_URL ?>/profile" class="back-btn"><i class="fas fa-arrow-left"></i> RETOUR</a>
             <div class="song-info">
    ...
    <audio id="audio" src="<?= BASE_URL ?>/uploads/mp3/<?php echo htmlspecialchars($music['filename']); ?>" crossorigin="anonymous"></audio>

    <script>
        const commentsData = <?php echo json_encode($comments); ?>;
        const isUserLoggedIn = <?php echo \Core\Auth::check() ? 'true' : 'false'; ?>;
    </script>
