        ...
        <?php if(isset($musics)): foreach ($musics as $m): ?>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="/music?id=<?= $m['id']; ?>" class="btn btn-primary" style="display:block; text-align:center; margin-top:auto;" aria-label="Écouter <?= htmlspecialchars($m['title']); ?>">Écouter ▶</a>
                </div>
            </div>
